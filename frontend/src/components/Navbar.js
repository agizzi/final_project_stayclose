        ...
        if (localStorage.getItem('access_key')) {
            return (
                <div className="navbar">
                    <h1 className="nav"> {this.props.username}'s StayClose </h1>
                    <ul className="links">
                        <li><button type="button" className="add"><Link className="nav"> {this.props.username}'s Account </Link></button></li>
