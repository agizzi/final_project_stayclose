  ...
  render() {
    return (
      <div className="postButton">
        ...
        <button type="button" className="delete" onClick={(e) => this.handleDelete()}>Delete Circle</button>
        <button type="button" className="addMember" onClick={this.handleOpenModal}>Add Member</button>
